...
#define RAISE2 LT(_RAISE,KC_X)
#define LOWER2 LT(_LOWER,KC_DOT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        SFT_SPC, LALT_T(KC_Z),    RAISE2,    KC_C,    KC_V,    RAISE,              LOWER,   KC_M,    KC_COMM, LOWER2,  LGUI_T(KC_SLSH), SFT_ENT
    ),
    ...
    [_LOWER] = LAYOUT(
        ...
        RESET, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,             KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_PLUS, _______,
        SFT_MHEN,KC_UNDS, KC_PIPE, KC_MINS, KC_UNDS, KC_BSLS,             KC_WH_R, KC_WH_U, KC_WH_D, KC_WH_L, KC_EQL,  SFT_HENK
    ),
    /* RAISE
     * +-----------------------------------------+                             +-----------------------------------------+
    ...
    [_RAISE] = LAYOUT(
        ...
        SFT_MHEN,KC_EXLM, KC_QUES, KC_TILD, KC_LPRN, KC_LBRC,             KC_RBRC, KC_RPRN, _______, _______, KC_EQL,  SFT_HENK
    )
};
